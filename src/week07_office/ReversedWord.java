...
public class ReversedWord {
    ...
    public static void main(String[] args) {
        ...
        for (int i = eachWord[1].length() - 1; i >= 0; i--) { // eachWord[1] is the middle word
            reverse += eachWord[1].charAt(i); // eachWord[1] is always the middle word,
            // so we are doing charAt(i) on that value. The charAt(i) reads the characters of the middle word backwards
        }
