...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(AccessModifiers.publicData); // public is always accessible outside in different packages

     //   System.out.println(AccessModifiers.protectedData); // protected is not always accessible
