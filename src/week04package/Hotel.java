    ...
    public static void main(String[] args) {
        ...
        switch (numOfPeople){
            ...
            case 6:
                ...
                break;
            default:
                System.out.println("sorry " + numOfPeople + " is not a vaild group size");
                isValid = false;

        }

        if (isValid) {
            System.out.println("You are assigned to a " + roomType + " for " + numOfPeople + " so total comes to $ " + price);
        }

        /*

        if (valid days && valid people)
