    ...
    public static void main(String[] args) {
     ...
     /*   for (Dog dog : dogs) {
      ...
      /*  for (Dog dog : dogs) {
        ...
        list.removeIf( p -> p.size.equalsIgnoreCase("small"));  // remove small dogs


        dogs2 = list.toArray(new Dog[list.size()]);  // convert array to array list, its will create new array with new size without small dogs
