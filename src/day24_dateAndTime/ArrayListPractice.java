...
public class ArrayListPractice {
    ...
    public static void main(String[] args) {
        ...
        for (Employee each  : employees) {  // data type of each is Employee
            ...
            for(Employee each : employees){
                if(each.jobTitle.equals("Java Developer")){  // if the job title of the employee is Java Dev
        ...
        System.out.println("Total number of female employees: " + maleEmployees.size());
    }
}
