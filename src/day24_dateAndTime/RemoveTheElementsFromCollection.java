...
public class RemoveTheElementsFromCollection {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < list.size(); i++) {
            if(list.get(i) < 4){
                list.remove(i);     // DONT USE IT IN LOOP
            }
        ...
        list2.removeIf( p -> p < 4 ); // name of the variable is p, so if p is < 4 remove it
        ...
        names.addAll( Arrays.asList("Java", "Python", "C#", "Ruby", "C++", "C"));
