...
public class Palindrome {
    ...
    public static void main(String[] args) {
      ...
      /*  [IQ] Palindrome [method, String, loop]
        ...
        A palindrome is when the characters being read from the beginning match the characters being read from the end. In other words,
         it can be thought as the reverse of a word being the same as the original word
