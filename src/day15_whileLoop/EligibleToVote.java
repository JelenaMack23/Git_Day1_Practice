...
public class EligibleToVote {
    ...
    public static void main(String[] args) {
        ...
        while ( ! ( age >= 1 && age <= 120 )){  // while the age is not valid
            ...
            System.err.println("Invalid entry. Please re-enter your age:");  // print the error message in red letters
            age = input.nextInt();  // assign it back to age
        }
        ...
        while ( ! (yesOrNo.equals("yes") || yesOrNo.equals("no"))  ){ // while the answer is neither yes nor no
            ...
            System.err.println("Invalid Entry! Please re-enter");   // print error message
